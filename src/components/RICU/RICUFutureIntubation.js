...
export default class RICUFutureIntubation extends React.Component {
        ...
        <View style={styles.middle}>
          <View style={{
            ...
            <Text style={{
              ...
              fontSize: Dimensions.get('window').height/29 }}>Risk of needing future intubation?</Text>
          </View>



          <View style={{flexDirection: 'row'}}>
            <View style={{ marginBottom: Dimensions.get('window').height/60, marginRight: Dimensions.get('window').width/15}}>
              <TouchableOpacity
            ...
            <View>
              <TouchableOpacity
                style={styles.customBtnBG} 
                onPress={() => this.props.navigation.navigate('RICURiskFactors')}>
